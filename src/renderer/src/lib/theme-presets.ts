...
const PRESET_DEFINITIONS: Record<AppThemePreset, ThemePresetDefinition> = {
  ...
  jade: {
    id: 'jade',
    labelKey: 'general.themePreset.presets.jade.label',
    descriptionKey: 'general.themePreset.presets.jade.desc',
    swatches: ['#2d716e', '#5cb8b2', '#fbfcfb'],
    preview: {
      light: {
        rail: '#f1f5f4',
        canvas: '#fbfcfb',
    ...
    cssVars: {
      light: {
        ...
        '--foreground': '#0a1413',
        '--card': '#ffffff',
        '--card-foreground': '#0a1413',
        '--popover': '#ffffff',
        '--popover-foreground': '#0a1413',
        '--primary': '#2d716e',
        '--primary-foreground': '#ffffff',
        '--secondary': '#ecf0ef',
        '--secondary-foreground': '#235a58',
        '--muted': '#ecf0ef',
        '--muted-foreground': '#6b7878',
        '--accent': '#f0f7f5',
        '--accent-foreground': '#2d716e',
        '--destructive': '#b91c1c',
        ...
        '--chart-5': '#c4e3e0',
        '--sidebar': '#f1f5f4',
        '--sidebar-foreground': '#0a1413',
        '--sidebar-primary': '#2d716e',
        '--sidebar-primary-foreground': '#ffffff',
        '--sidebar-accent': '#e2ecea',
        '--sidebar-accent-foreground': '#235a58',
        '--sidebar-border': '#dde4e2',
        '--sidebar-ring': '#3d8a85',
        '--workspace-titlebar-bg': '#fbfcfb',
        '--workspace-titlebar-border': '#e5ebe9',
        '--workspace-titlebar-button-hover': '#eef3f2',
        '--workspace-titlebar-toolgroup-bg': '#f4f7f6',
        '--workspace-titlebar-toolgroup-border': '#dde4e2',
        '--workspace-titlebar-toolbutton-hover': '#e9efee',
        '--workspace-titlebar-toolbutton-active': '#dfe8e6',
        '--workspace-sidebar-divider': '#dde4e2',
        '--workspace-sidebar-section-border': '#e3e9e7',
        '--workspace-sidebar-row-hover-bg': '#e8efed',
        '--workspace-sidebar-row-hover-border': '#d8e1df',
        '--workspace-sidebar-row-active-bg': '#dfe8e6',
        '--workspace-sidebar-row-active-border': '#cfdad7',
        '--workspace-sidebar-row-active-shadow': '0 10px 18px -16px rgba(45, 113, 110, 0.16)',
        '--activity-card-bg': '#ffffff',
        '--activity-card-border': '#dde4e2',
        '--activity-card-divider': '#ecf0ef',
        '--activity-card-header-hover': '#eef3f2',
        '--activity-card-shadow': '0 14px 28px -22px rgba(45, 113, 110, 0.14)',
        '--composer-shell-top': '#ffffff',
        '--composer-shell-bottom': '#ffffff',
        '--composer-shell-border': '#dde4e2',
        '--composer-shell-border-focus': 'color-mix(in srgb, #3d8a85 32%, #dde4e2)',
        '--composer-shell-shadow':
          '0 14px 30px -24px rgba(45, 113, 110, 0.14), 0 1px 2px rgba(10, 20, 19, 0.05)',
        '--composer-shell-shadow-focus':
          '0 18px 34px -24px rgba(45, 113, 110, 0.18), 0 0 0 3px rgba(45, 113, 110, 0.14)',
        '--composer-toolbar-border': '#ecf0ef',
        '--composer-panel-bg': '#ffffff',
        '--composer-panel-border': '#dde4e2',
        '--composer-panel-shadow':
          '0 20px 36px -28px rgba(45, 113, 110, 0.14), 0 1px 2px rgba(10, 20, 19, 0.05)',
        '--composer-control-bg-hover': '#eef3f2',
        '--composer-control-active-text': '#0a1413',
        '--composer-send-start': '#2d716e',
        '--composer-send-end': '#235a58',
        '--composer-send-foreground': '#ffffff',
        '--composer-chip-border': '#dde4e2',
        '--composer-chip-text': '#526260',
        '--composer-chip-hover': '#eef3f2',
        '--composer-drop-bg': '#e8efed'
      },
      dark: {
        '--background': '#101716',
        '--foreground': '#e6edeb',
        ...
        '--chart-5': '#cbe8e5',
        '--sidebar': '#0c1211',
        '--sidebar-foreground': '#e6edeb',
        '--sidebar-primary': '#4da8a2',
        '--sidebar-primary-foreground': '#06201e',
        '--sidebar-accent': '#1c2a28',
        '--sidebar-accent-foreground': '#7cc4bf',
        '--sidebar-border': '#233030',
        '--sidebar-ring': '#4da8a2',
        '--workspace-titlebar-bg': '#101716',
        '--workspace-titlebar-border': '#233030',
        '--workspace-titlebar-button-hover': '#1c2624',
        '--workspace-titlebar-toolgroup-bg': '#182120',
        '--workspace-titlebar-toolgroup-border': '#2a3533',
        '--workspace-titlebar-toolbutton-hover': '#1f2b29',
        '--workspace-titlebar-toolbutton-active': '#243230',
        '--workspace-sidebar-divider': '#233030',
        '--workspace-sidebar-section-border': '#233030',
        '--workspace-sidebar-row-hover-bg': '#1c2624',
        '--workspace-sidebar-row-hover-border': '#2a3533',
        '--workspace-sidebar-row-active-bg': '#1f2e2c',
        '--workspace-sidebar-row-active-border': '#31403e',
        '--workspace-sidebar-row-active-shadow': '0 14px 24px -22px rgba(0, 0, 0, 0.4)',
        '--activity-card-bg': '#182120',
        '--activity-card-border': '#2a3533',
        '--activity-card-divider': '#233030',
        '--activity-card-header-hover': '#1f2b29',
        '--activity-card-shadow': '0 18px 32px -24px rgba(0, 0, 0, 0.4)',
        '--composer-shell-top': '#1c2624',
        '--composer-shell-bottom': '#1c2624',
        '--composer-shell-border': '#2a3533',
        '--composer-shell-border-focus': 'color-mix(in srgb, #4da8a2 32%, #2a3533)',
        '--composer-shell-shadow':
          '0 18px 32px -24px rgba(0, 0, 0, 0.38), 0 1px 2px rgba(0, 0, 0, 0.22)',
        '--composer-shell-shadow-focus':
          '0 22px 36px -24px rgba(0, 0, 0, 0.42), 0 0 0 3px rgba(77, 168, 162, 0.18)',
        '--composer-toolbar-border': '#2a3533',
        '--composer-panel-bg': '#1c2624',
        '--composer-panel-border': '#2a3533',
        '--composer-panel-shadow':
          '0 22px 40px -28px rgba(0, 0, 0, 0.46), 0 1px 2px rgba(0, 0, 0, 0.24)',
        '--composer-control-bg-hover': '#243230',
        '--composer-control-active-text': '#e6edeb',
        '--composer-send-start': '#4da8a2',
        '--composer-send-end': '#3d8a85',
        '--composer-send-foreground': '#06201e',
        '--composer-chip-border': '#2a3533',
        '--composer-chip-text': '#a9b8b5',
        '--composer-chip-hover': '#243230',
        '--composer-drop-bg': '#1f2e2c'
      }
    },
    terminal: {
      light: createTerminalTheme({
        background: '#fbfcfb',
        foreground: '#0a1413',
        selectionBackground: 'rgba(45, 113, 110, 0.16)',
        cursor: '#2d716e',
        black: '#0a1413',
        red: '#b91c1c',
        green: '#2d716e',
      ...
      dark: createTerminalTheme({
        background: '#0c1211',
        foreground: '#e6edeb',
        selectionBackground: 'rgba(77, 168, 162, 0.22)',
        cursor: '#4da8a2',
        black: '#0c1211',
        red: '#f08080',
        green: '#5cb8b2',
    ...
    ssh: {
      light: {
        ...
        libraryFrameEnd: '#f4f7f6',
        libraryBorder: '#e5ebe9',
        libraryText: '#0a1413',
        connectFrame: '#fbfcfb',
        connectBorder: '#dde4e2',
        connectText: '#526260',
        terminalFrame: '#12201e',
        terminalBorder: 'rgba(255,255,255,0.08)',
        terminalText: '#e6edeb',
        canvas: '#fbfcfb',
        canvasSubtle: '#ffffff',
        ...
        badge: '#2d716e',
        libraryPill: '#ecf0ef',
        libraryPillActive: '#dfe8e6',
        libraryPillText: '#526260',
        libraryPillActiveText: '#235a58',
        connectPill: '#ecf0ef',
        connectPillActive: '#dfe8e6',
        connectPillText: '#526260',
        connectPillActiveText: '#235a58',
        terminalPill: 'rgba(255,255,255,0.08)',
        terminalPillActive: '#1f2e2c',
        terminalPillText: '#cbdad7',
        terminalPillActiveText: '#e6edeb'
      },
      dark: {
        libraryFrameStart: '#0c1211',
        libraryFrameEnd: '#101716',
        libraryBorder: 'rgba(255,255,255,0.08)',
        libraryText: '#e6edeb',
        connectFrame: '#0c1211',
        connectBorder: '#233030',
        connectText: '#8e9b99',
        terminalFrame: '#0a1010',
        terminalBorder: 'rgba(255,255,255,0.08)',
        terminalText: '#e6edeb',
        canvas: '#0c1211',
        canvasSubtle: '#101716',
        terminalCanvas: '#0a1010',
        panel: '#182120',
        panelStrong: '#101716',
        panelBorder: 'rgba(255,255,255,0.08)',
        surface: '#182120',
        surfaceStrong: '#1c2624',
        text: '#e6edeb',
        muted: '#8e9b99',
        accent: '#4da8a2',
        accentSoft: '#1c2a28',
        accentContrast: '#06201e',
        success: '#5cb8b2',
        successSoft: '#122624',
        warning: '#d9a441',
        warningSoft: '#2a2513',
        ...
        libraryPill: 'rgba(255,255,255,0.08)',
        libraryPillActive: 'rgba(255,255,255,0.14)',
        libraryPillText: '#cbdad7',
        libraryPillActiveText: '#ffffff',
        connectPill: '#182120',
        connectPillActive: '#243230',
        connectPillText: '#8e9b99',
        connectPillActiveText: '#e6edeb',
        terminalPill: 'rgba(255,255,255,0.08)',
        terminalPillActive: '#243230',
        terminalPillText: '#cbdad7',
        terminalPillActiveText: '#e6edeb'
      }
    }
