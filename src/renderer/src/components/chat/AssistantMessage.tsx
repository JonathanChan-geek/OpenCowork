...
import { StreamdownRender } from '@renderer/components/markdown/streamdown-render'
...
const MarkdownContent = React.memo(function MarkdownContent({
  ...
  return <StreamdownRender content={text} streaming={isStreaming} />
})
...
function StreamingMarkdownContent({
  ...
  if (isStreaming) {
    return (
      ...
      >
        <MarkdownContent text={renderPool.text} isStreaming />
      </div>
    )
  }
